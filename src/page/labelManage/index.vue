    ...
    <div class="labelManage">
        ...
        <el-table  :data="labelList" border fit highlight-current-row style="width: 100%">
            ...
            <template slot-scope="{row}" >
                ...
                <el-button v-if="row.state!=0" type="success" @click="preview(row.id)" size="mini">预览</el-button>
            </template>
            </el-table-column>
        </el-table>
            ...
            <el-form ref="dataForm" :model="label" :rules="classRules" label-position="left" label-width="100px" style="width: 80%; margin-left:50px;">
                ...
                <el-form-item label="上传头图" prop="img" class="total_box">
                    ...
                    <el-popover
                        ...
                        trigger="hover">
                        <img :src="label.img">
                        <img slot="reference" :src="label.img" class="img_box">
                    </el-popover>
                    <!-- <img :src="label.img" class="img_box"> -->
                </el-form-item>
                <el-form-item label="选择名宿" prop="labelId">
            ...
            <el-form ref="dataForm" :model="house" :rules="lableRules" label-position="left" label-width="100px" style="width: 80%; margin-left:50px;">
                ...
                <el-form-item label="上传大图" prop="labelImgMax" class="total_box">
                    ...
                    <el-popover
                        ...
                        title=""
                        trigger="hover">
                        <img :src="house.labelImgMax">
                        <img slot="reference" :src="house.labelImgMax" class="img_box">
                    </el-popover>
                ...
                <el-form-item label="上传小图" prop="labelImgMIn" class="total_box">
                    ...
                    <el-popover
                        ...
                        title=""
                        trigger="hover">
                        <img :src="house.labelImgMIn">
                        <img slot="reference" :src="house.labelImgMIn" class="img_box">
                    </el-popover>
...
export default {
    ...
    methods: {
        ...
        preview (id) {
          ...
          this.iframeUrl = 'https://h5.qiaomukeji.com/201909/HomeMap/mapDome/v13/details.html?searchText='+id
        }
    },
    mounted(){
      this.getClassifyList()
